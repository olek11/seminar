                ...
                <div class="row mb-2">
                    <div class="col-xl-12 mb-2">
                        ...
                        <select name="ruang_id" class="form-control @error('ruang_id') is-invalid @enderror" required>
                            ...
                            @foreach ($ruang as $item)
                                <option value="{{ $item->id }}" {{ $peminjaman->ruang_id == $item->id ? 'selected' : '' }}>
                                    {{ $item->name }} ({{ $item->kode }})
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-xl-12 mb-2">
                        ...
                        <input type="date" name="tanggal_peminjaman" class="form-control @error('tanggal_peminjaman') is-invalid @enderror"
                               value="{{ old('tanggal_peminjaman', $peminjaman->tanggal_peminjaman ? date('Y-m-d', strtotime($peminjaman->tanggal_peminjaman)) : '') }}" required>
                    ...
                    <div class="col-xl-6 mb-2">
                        ...
                        <input type="time" name="waktu_mulai" class="form-control @error('waktu_mulai') is-invalid @enderror"
                               value="{{ old('waktu_mulai', $peminjaman->waktu_mulai ? date('H:i', strtotime($peminjaman->waktu_mulai)) : '') }}" required>
                        @error('waktu_mulai')
                            <small class="text-danger">
                                {{ $message }}
                            </small>
                    ...
                    <div class="col-xl-6 mb-2">
                        ...
                        <input type="time" name="waktu_selesai" class="form-control @error('waktu_selesai') is-invalid @enderror"
                               value="{{ old('waktu_selesai', $peminjaman->waktu_selesai ? date('H:i', strtotime($peminjaman->waktu_selesai)) : '') }}" required>
                        @error('waktu_selesai')
                            <small class="text-danger">
                                {{ $message }}
                            </small>
                    ...
                    <div class="col-xl-12 mb-2">
                        ...
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                               value="{{ old('name', $peminjaman->name) }}" required>
                        @error('name')
                            <small class="text-danger">
                                {{ $message }}
                            </small>
